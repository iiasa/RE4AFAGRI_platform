...
sc_ref = message_ix.Scenario(mp, modelName, "test", version='new',annotation="load from excel")

sc_ref.read_excel(private_data_path("projects","leap_re_nest","ref_scen.xlsx"),
                    add_units=True,
                    init_items=True,
                    commit_steps=True)
sc_ref.commit("")
sc_ref.solve(solve_options={"lpmethod": "4"},model="MESSAGE")
