...
nest_r_1 <- nest_r_1 %>% ungroup() %>% tidyr::complete(variable, scenario, subannual, year)
...
nest_r_2 <- nest_r_2 %>% ungroup() %>% tidyr::complete(variable, scenario, subannual, year)
...
nest_r_3$variable = paste0(ifelse(gsub("Investment\\|Energy Supply\\|Electricity\\|", "", nest_r_3$variable)=="Investment|Energy Supply|Electricity", "total", gsub("Investment\\|Energy Supply\\|Electricity\\|", "", nest_r_3$variable)), "_bn_usd_yr")
nest_r_3$value <- nest_r_3$value*1000
nest_r_3$variable = paste0("electricity_investment_", nest_r_3$variable)
...
nest_r_4$variable = paste0(ifelse(gsub("Secondary Energy\\|Electricity\\|", "", nest_r_4$variable)=="Secondary Energy|Electricity", "total", gsub("Secondary Energy\\|Electricity\\|", "", nest_r_4$variable)), "_twh_yr")
nest_r_4$variable = paste0("electricity_supply_", nest_r_4$variable)
nest_r_4 <- nest_r_4 %>% ungroup() %>% tidyr::complete(variable, scenario, subannual, year)
...
nest_r_6 <- nest_r_6 %>% ungroup() %>% tidyr::complete(variable, scenario, subannual, year)
...
nest_r_7 <- nest_r_7 %>% ungroup() %>% tidyr::complete(variable, scenario, subannual, year)
