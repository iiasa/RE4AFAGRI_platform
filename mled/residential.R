...
clusters[paste0('PerHHD_ely_tt' , "_", timestep)] <- pull(aa[paste0('PerHHD_ely' , "_", timestep)]) * clusters$HHs * ifelse(latent_d_tot == T, 1, pmax((scenarios$el_access_share_target[scenario]  - clusters$elrate), 0))
