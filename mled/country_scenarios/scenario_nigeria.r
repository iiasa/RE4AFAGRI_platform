...
# Country parameters
countryname = 'Nigeria' 
countryiso3 = 'NGA' # ISO3
national_official_population = 206000000 # number of people
national_official_elrate = 0.55 # national residential electricity access rate
...
population_baseline <- rast(find_it("NGA_population_v2_0_gridded_WorldPop_GRID3.tif"))
...
crops = readxl::read_xlsx(find_it('crops_cfs_ndays_months_NGA.xlsx'))
...
#save.image(paste0(processed_folder, "scenario_nigeria.Rdata"))
