...
clusters <- read_sf(find_it("GRID3_Rwanda_Settlements.geojson"), crs=4326)
...
clusters_nest <- read_sf(find_it("Rwanda_NEST_delineation.shp"))
...
population_baseline <- raster(find_it("RWA_population_v1_0_gridded.tif"))
